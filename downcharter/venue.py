...
THEMES = {
    ...
    "pop":     {"calm": (["harmony", "loop_warm"], ["ProFilm_a", "bloom"]),
                "mid": (["manual_warm", "searchlights"], ["bright", "ProFilm_b"]),
...
SECTION_LIGHT_POOL = {
    ...
    "solo": {
        ...
        "mid":  ["harmony", "searchlights", "manual_warm", "flare_fast", "sweep"],
    ...
    "outro": {
        "calm": ["blackout_spot", "flare_fast", "searchlights", "manual_warm", "silhouettes"],
        "mid":  ["flare_fast", "manual_warm", "loop_cool", "loop_warm", "blackout_spot"],
        "high": ["sweep", "dischord", "searchlights", "flare_fast", "manual_warm"],
    },
    "default": {
